	...
	pet_horario = {
		...
		init: function() {
			var hora = 0;
			 horaArray = [];
			while(hora < 24){
				horaArray.push(hora+":00");
				hora++;
			};
			horaArray.sort();

			$("#horario_artefato,#horario_laser,#horario_som,#horario_dispenser_a,#horario_dispenser_c").tagHandler({				
				availableTags: horaArray,
				autocomplete: true
			});
		}
